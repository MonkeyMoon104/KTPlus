package com.monkey.ktplus.effects.list.sandstorm.animation.util;
...
public final class SandstormDisplays {
    private static final int INTERPOLATION_TICKS = 2;

    private SandstormDisplays() {}

    public static @Nullable ItemDisplay spawnGrain(Location location, Material material, float scale) {
