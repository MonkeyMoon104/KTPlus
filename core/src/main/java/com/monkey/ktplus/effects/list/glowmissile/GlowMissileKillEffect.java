package com.monkey.ktplus.effects.list.glowmissile;
...
public final class GlowMissileKillEffect implements KillEffect {
    private final EffectDefinition definition;
    private final VisualEffectService visuals;

    public GlowMissileKillEffect(EffectDefinition definition, VisualEffectService visuals) {
    ...
    public void execute(EffectContext context, EffectSession session) {
        ...
        GlowMissileLauncher.launch(session, visuals, context, context.location());
    }
}
