package com.monkey.ktplus.effects.list.arcade.animation.util;
...
public final class ArcadeDisplays {
    private static final int INTERPOLATION_TICKS = 2;

    private ArcadeDisplays() {}

    public static @Nullable ItemDisplay spawnCabinet(Location location) {
        return spawn(location, Material.JUKEBOX, 0.85f, 0.55f);
    }

    public static @Nullable ItemDisplay spawnEnemy(Location location, Material material) {
        return spawn(location, material, 0.42f, 0.2f);
    }
    ...
    public static void place(
        ...
        display.setTransformation(new Transformation(
                new Vector3f(0.0f, safe * 0.4f, 0.0f),
                rotation,
    ...
    private static @Nullable ItemDisplay spawn(
        ...
        return location.getWorld().spawn(at, ItemDisplay.class, display -> {
            ...
            display.setTeleportDuration(INTERPOLATION_TICKS);
            display.setTransformation(new Transformation(
                    new Vector3f(0.0f, scale * 0.4f, 0.0f),
                    new Quaternionf(),
