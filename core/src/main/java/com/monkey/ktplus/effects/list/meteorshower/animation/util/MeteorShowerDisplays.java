package com.monkey.ktplus.effects.list.meteorshower.animation.util;
...
public final class MeteorShowerDisplays {
    private static final int INTERPOLATION_TICKS = 1;

    private MeteorShowerDisplays() {}

    public static Material meteorMaterial(int index) {
        return switch (index % 3) {
            case 0 -> MaterialResolver.resolve("MAGMA_BLOCK", "NETHERRACK");
            case 1 -> MaterialResolver.resolve("FIRE_CHARGE", "BLAZE_POWDER");
            default -> MaterialResolver.resolve("NETHERRACK", "ORANGE_CONCRETE");
        };
    }
