package com.monkey.ktplus.effects.list.bubbletrap.animation.util;
...
public final class BubbleTrapDisplays {
    private static final int INTERPOLATION_TICKS = 2;

    private BubbleTrapDisplays() {}

    public static @Nullable ItemDisplay spawnBubble(Location location, Material material, float scale) {
