package com.monkey.ktplus.effects.list.snowballstorm.animation.util;
...
public final class SnowballStormDisplays {
    private static final int INTERPOLATION_TICKS = 1;

    private SnowballStormDisplays() {}

    public static @Nullable ItemDisplay spawn(Location location, float scale) {
