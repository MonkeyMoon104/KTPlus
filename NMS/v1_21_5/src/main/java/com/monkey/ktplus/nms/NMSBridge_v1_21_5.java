...
public final class NMSBridge_v1_21_5 extends AbstractPlatformNmsBridge {
    static {
    ...
    public NMSBridge_v1_21_5() {
        super(CompatBridgeRegistry.forModule("v1_21_5"), PlatformCapabilitySets.modernPaper());
    }
