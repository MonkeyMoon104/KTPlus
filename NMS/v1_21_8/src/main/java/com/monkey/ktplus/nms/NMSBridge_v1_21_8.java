...
public final class NMSBridge_v1_21_8 extends AbstractPlatformNmsBridge {
    static {
    ...
    public NMSBridge_v1_21_8() {
        super(CompatBridgeRegistry.forModule("v1_21_8"), PlatformCapabilitySets.modernPaper());
    }
