...
public final class NMSBridge_v1_21_1 extends AbstractPlatformNmsBridge {
    static {
    ...
    public NMSBridge_v1_21_1() {
        super(CompatBridgeRegistry.forModule("v1_21_1"), PlatformCapabilitySets.modernPaper());
    }
