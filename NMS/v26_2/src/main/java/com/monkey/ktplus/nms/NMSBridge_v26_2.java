...
public final class NMSBridge_v26_2 extends AbstractPlatformNmsBridge {
    static {
    ...
    public NMSBridge_v26_2() {
        super(CompatBridgeRegistry.forModule("v26_2"), PlatformCapabilitySets.modernV26());
    }
