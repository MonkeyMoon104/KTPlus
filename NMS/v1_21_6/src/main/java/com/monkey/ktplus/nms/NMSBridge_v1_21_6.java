...
public final class NMSBridge_v1_21_6 extends AbstractPlatformNmsBridge {
    static {
    ...
    public NMSBridge_v1_21_6() {
        super(CompatBridgeRegistry.forModule("v1_21_6"), PlatformCapabilitySets.modernPaper());
    }
