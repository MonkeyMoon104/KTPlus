...
public final class NMSBridge_v26_1 extends AbstractPlatformNmsBridge {
    static {
    ...
    public NMSBridge_v26_1() {
        super(CompatBridgeRegistry.forModule("v26_1"), PlatformCapabilitySets.modernV26());
    }
