...
public final class NMSBridge_v1_21_7 extends AbstractPlatformNmsBridge {
    static {
    ...
    public NMSBridge_v1_21_7() {
        super(CompatBridgeRegistry.forModule("v1_21_7"), PlatformCapabilitySets.modernPaper());
    }
