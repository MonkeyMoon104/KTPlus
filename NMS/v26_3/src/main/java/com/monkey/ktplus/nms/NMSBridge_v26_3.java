...
public final class NMSBridge_v26_3 extends AbstractPlatformNmsBridge {
    static {
    ...
    public NMSBridge_v26_3() {
        super(CompatBridgeRegistry.forModule("v26_3"), PlatformCapabilitySets.modernV26());
    }
