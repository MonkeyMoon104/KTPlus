...
public final class NMSBridge_v1_21_3 extends AbstractPlatformNmsBridge {
    static {
    ...
    public NMSBridge_v1_21_3() {
        super(CompatBridgeRegistry.forModule("v1_21_3"), PlatformCapabilitySets.modernPaper());
    }
