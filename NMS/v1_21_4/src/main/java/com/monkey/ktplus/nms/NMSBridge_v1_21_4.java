...
public final class NMSBridge_v1_21_4 extends AbstractPlatformNmsBridge {
    static {
    ...
    public NMSBridge_v1_21_4() {
        super(CompatBridgeRegistry.forModule("v1_21_4"), PlatformCapabilitySets.modernPaper());
    }
