...
public final class NMSBridge_v1_21_11 extends AbstractPlatformNmsBridge {
    static {
    ...
    public NMSBridge_v1_21_11() {
        super(CompatBridgeRegistry.forModule("v1_21_11"), PlatformCapabilitySets.modernPaper());
    }
