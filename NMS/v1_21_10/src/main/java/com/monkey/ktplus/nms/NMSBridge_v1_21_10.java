...
public final class NMSBridge_v1_21_10 extends AbstractPlatformNmsBridge {
    static {
    ...
    public NMSBridge_v1_21_10() {
        super(CompatBridgeRegistry.forModule("v1_21_10"), PlatformCapabilitySets.modernPaper());
    }
